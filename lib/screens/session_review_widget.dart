...
class SessionReviewWidget extends StatelessWidget {
  ...
  void onButton3BackContainedATextLightCopyPressed(BuildContext context) =>
      Navigator.push(
          ...
          MaterialPageRoute(
              builder: (context) =>
                  AllSessionsPreSessionWidget()));

  void onThresholdGraphLongPressed(BuildContext context) =>
      Navigator.push(context,
          MaterialPageRoute(builder: (context) => SessionDetailWidget()));
  ...
  Row buildSessionControl(BuildContext context) {
    return Row(
              children: [
                FlatButton(
                  onPressed: () =>
                      this.onIconNavigationArrowDropUp24pxPressed(context),
